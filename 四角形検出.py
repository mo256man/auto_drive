# https://qiita.com/sitar-harmonics/items/ac584f99043574670cf
    ...
    for i, cnt in enumerate(contours):
        ...
        if approx.shape[0] == 4 and area > cond_area and cv2.isContourConvex(approx) :
            ...
            if maxCosine < 0.3 :
                ...
                print(rcnt)
                cv2.polylines(image, [rcnt], True, (0,255,255), thickness=2, lineType=cv2.LINE_8)
    return image

def main():
    file = "labels//mask_1.jpg"
